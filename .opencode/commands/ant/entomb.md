...
- Execute `AETHER_OUTPUT_MODE=visual aether entomb $ARGUMENTS` exactly once after the owner chooses it. Show this output to the owner in your own reply, unchanged — you are relaying what the command produced, not computing, gating, or re-verifying anything.
