...
class InteractiveCommands:
    ...
    async def colonize(self) -> str:
        ...
        Note: Can be run before /ant:init to analyze existing codebase.
        """
        # Start system if not started (colonize doesn't require init first)
        if not self.started:
            await self.system.start()
            self.started = True
        ...
        output.append("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        output.append("")
        output.append("Colony mobilizing to analyze codebase...")
        output.append("")
        output.append("Worker Ants:")
        output.append("  🐜 Mapper: Exploring codebase structure")
        output.append("  🐜 Researcher: Identifying technologies")
        output.append("  🐜 Planner: Analyzing architecture")
        output.append("  🐜 Synthesizer: Extracting patterns")
        output.append("  🐜 Verifier: Finding issues")
        output.append("")
        output.append("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        output.append("")
        output.append("✅ COLONY MOBILIZED")
        output.append("")
        output.append("Worker Ants are analyzing your codebase.")
        output.append("Use /ant:status to see what they've discovered.")
        output.append("")
        output.append("When ready, run /ant:init \"<your goal>\" to start building.")
