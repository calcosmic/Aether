 ...
 */
export function deriveWorkflowPattern(dispatches) {
 ...
 */
export function mapVerificationDepth(depth) {
 ...
 */
export function formatQueenRecommendation(rec) {
 ...
 */
export function deriveExecutionPolicy(rec, pattern, existingPolicy) {
    const policy = {
