 ...
 */
export function classifyFailure(opts, status, summary) {
    try {
...
function isRuntimeOwnedRecoveryIssue(summary) {
    const lower = summary.toLowerCase();
    return ((lower.includes("stale") && lower.includes("clarification")) ||
 ...
 */
function mapClassificationToAction(classification) {
 ...
 */
export function handleWaveFailures(opts, failures) {
 ...
 */
export function formatRecoveryActions(actions) {
    if (actions.length === 0) {
