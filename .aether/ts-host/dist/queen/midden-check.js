 ...
 */
export function checkMiddenThreshold(opts, threshold = 3) {
    let total = 0;
    const categories = {};
    try {
        const reviewResult = callGoJSON(opts, ["midden-review"]);
 ...
 */
export function formatMiddenSummary(result) {
