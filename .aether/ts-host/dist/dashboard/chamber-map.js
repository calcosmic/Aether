 ...
 */
export function createChamberMap() {
    const activities = [];
    return {
        activities,
        update(workers) {
 ...
 */
export function renderChamberMap(map) {
 ...
 */
export function renderChamberMapData(activities) {
    if (activities.length === 0) {
        return "Chamber Activity\n  (no activity yet)";
    }
    const lines = ["Chamber Activity"];
 ...
 */
export function extractDirectoryPrefix(path) {
