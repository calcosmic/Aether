...
import { renderDashboardFrame, clearDashboard, } from "./dashboard/dashboard-renderer.js";
import { createChamberMap } from "./dashboard/chamber-map.js";
// ---------------------------------------------------------------------------
// Public API
// ---------------------------------------------------------------------------
/**
...
export function createDashboard(opts) {
    ...
    const chamberMap = createChamberMap();
    let startTime = 0;
    let currentWave = 0;
    let totalWaves = 0;
    const oracleState = {
