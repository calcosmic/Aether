...
export const TERMINAL_WORKER_STATUSES: ReadonlySet<string> = new Set([
  "completed",
 ...
 */
export const SUCCESSFUL_WORKER_STATUSES: ReadonlySet<string> = new Set([
  "completed",
  "code_written",
  "completed_no_change",
  "manually-reconciled",
...
function normalizeWorkerStatus(status: unknown): string {
