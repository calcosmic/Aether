...
func init() {
	...
	continueCmd.Flags().Bool("no-learn", false, "Skip only the legacy learning-entry capture for this run (D-16, PRIV-05); observations and failure records are still written so a blocked check still records what broke -- see captureContinueMemory's doc comment")
	...
	continueFinalizeCmd.Flags().Bool("no-learn", false, "Skip only the legacy learning-entry capture for this run (D-16, PRIV-05); observations and failure records are still written so a blocked check still records what broke -- see captureContinueMemory's doc comment")
