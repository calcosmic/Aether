...
func TestSwarmWrapperCeremonyContract(t *testing.T) {
	...
	required := []string{
		...
		"## Wave Execution",
		"AETHER_FORCE_COLOR=1 AETHER_OUTPUT_MODE=visual aether ceremony wave-start --workflow swarm",
		...
		"AETHER_OUTPUT_MODE=visual aether ceremony closeout --workflow swarm --completion-file",
		"## After Swarm",
