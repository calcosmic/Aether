...
func TestFullSuiteRuntime200SerializesSharedResources(t *testing.T) {
	want := map[string]string{
		...
		"TestOracleCompatibilityWritesHeartbeatWhileRunning":   "live background heartbeat",
		"TestBuildDispatchStartsHeartbeatMonitor":              "live background heartbeat monitor",
		"TestHeartbeatMonitorStopsOnCancel":                    "live background heartbeat monitor lifecycle",
		"TestGoldenContinueVisualOutput":                       "byte-identical golden visual output",
