...
- [ ] **LEARN-05**: A worker's output demonstrably differs when colony memory is populated versus wiped — the learning loop is measured, not assumed
