...
- [x] Phase 1: Housekeeping and Foundation
- [x] Phase 2: Colony Scope System
- [x] Phase 3: Restore Build Ceremony
- [x] Phase 4: Restore Continue Ceremony
- [x] Phase 5: Living Watch and Status Surfaces
- [x] Phase 6: Pheromone Visibility and Steering
...
- [x] Phase 7: Context Ledger and Skill Routing Foundation
- [x] Phase 8: Prompt Integrity and Trust Boundaries
- [x] Phase 9: Trust-Weighted Context Assembly
- [x] Phase 10: Curation Spine and Structural Learning
- [x] Phase 11: Competitive Proof Surfaces and Evaluation
...
- [x] Phase 12: Dispatch Truth Model and Run Scoping
- [x] Phase 13: Live Workflow Visibility Across Colonize/Plan/Build
- [x] Phase 14: Worker Execution Robustness and Honest Activity Tracking
- [x] Phase 15: Verification-Led Continue and Partial Success
- [x] Phase 16: Recovery Reconciliation and Runtime UX Finalization
...
- [x] Phase 17: Slash Command Format Audit
- [x] Phase 18: Visual UX Restoration -- Caste Identity and Spawn Lists
- [x] Phase 19: Visual UX Restoration -- Stage Separators and Ceremony
- [x] Phase 19.1: Verify Stage Separators (INSERTED)
- [x] Phase 20: Visual UX Restoration -- Emoji Consistency
...
- [x] Phase 24: Trace Logging

</details>

<details>
<summary>v1.4 Self-Healing Colony (Phases 25-30) -- SHIPPED 2026-04-21</summary>

- [x] Phase 25: Medic Ant Core
- [x] Phase 26: Auto-Repair
- [x] Phase 27: Medic Skill
- [x] Phase 28: Ceremony Integrity
- [x] Phase 29: Trace Diagnostics
- [x] Phase 30: Medic Worker Integration

</details>

<details>
<summary>v1.5 Runtime Truth Recovery (Phases 31-38) -- SHIPPED 2026-04-23</summary>

- [x] Phase 31: P0 Runtime Truth Fixes
- [x] Phase 32: Continue Unblock
- [x] Phase 33: Dispatch Fixes
- [x] Phase 34: Cleanup
- [x] Phase 35: Platform Parity
- [x] Phase 36: Release Decision
- [x] Phase 37: Codebase Hygiene
- [x] Phase 38: Nyquist Validation Backfill

</details>

<details>
<summary>v1.6 Release Pipeline Integrity (Phases 39-46) -- SHIPPED 2026-04-24</summary>

- [x] Phase 39: OpenCode Agent Frontmatter
- [x] Phase 40: Stable Publish Hardening
- [x] Phase 41: Dev Channel Isolation
- [x] Phase 42: Downstream Stale Publish Detection
- [x] Phase 43: Release Integrity Checks
- [x] Phase 44: Doc Alignment and Archive Consistency
- [x] Phase 44.1: Downstream Runtime Bugs
- [x] Phase 44.2: Command Hygiene
- [x] Phase 45: E2E Regression Coverage
- [x] Phase 46: Stuck Plan Investigation
...
<details>
<summary>v1.10 Colony Polish (Phases 57-69) -- SHIPPED 2026-04-28</summary>

- [x] Phase 57: QUEEN.md Pipeline Fix
- [x] Phase 58: Smart Review Depth
- [x] Phase 59: Gate Failure Recovery
- [x] Phase 60: Oracle Loop Fix
- [x] Phase 61: Porter Ant
- [x] Phase 62: Lifecycle Ceremony -- Seal and Init
- [x] Phase 63: Lifecycle Ceremony -- Status, Entomb, Resume
- [x] Phase 64: Lifecycle Ceremony -- Discuss, Chaos, Oracle, Patrol
- [x] Phase 64.1: Fix Continue Watcher Timeout Blocking Advancement (INSERTED)
- [x] Phase 65: Idea Shelving
- [x] Phase 66: Continue Flow Fix
- [x] Phase 67: Seal Hive Brain Wiring
- [x] Phase 68: Gate Recovery Verification
- [x] Phase 69: Idea Shelving Verification
...
Plans:
- [ ] 90-01-PLAN.md -- pkg/learn/ types, LearnStore interface, ColonyStore CRUD + repo isolation tests (HIVE-01/02, LRN-05)
...
| 90. Learning Foundation | v1.13 | 0/4 | Planned | - |
