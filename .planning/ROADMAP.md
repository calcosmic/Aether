...
- [x] **Phase 198.2: Memory Reaches Every Helper** - Planning, colonizing, research and the welcome card get the same memory the builder gets; the codebase map is delivered as content, not filenames. (completed 2026-08-31; one real-world UAT carried as acknowledged debt)
...
- [x] 198.3-04-PLAN.md — apply the trigger policy in the real run loop and make replanning lesson-aware
