...
- [ ] 196-02-PLAN.md — One authoritative token type: every billed column on the chat-model client, both accounting paths locked to one total, the invented length-derived figure deleted at source, and a ratchet forbidding its return (wave 1)
