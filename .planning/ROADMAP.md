...
- [ ] 163.1-08-PLAN.md — Gap closure: validate the bytes the wrapper submitted, so unknown fields and type errors are rejected together (req 1/2) [wave 1]
- [ ] 163.1-09-PLAN.md — Gap closure: criterion evidence and the --read-only-artifact escape hatch reach the plan-only → continue-finalize path (req 5) [wave 1]
