# Requirements Archive: v1.26 Intelligent Orchestration
...
- [x] **ROSTER-01**: The `colony/agents/*.yaml` zero-reader contradiction is resolved by an explicit recorded ruling — wired with executable proof, or deleted with the compiled registry documented as authoritative *(reworded 2026-08-13; original: "has a working Go reader")*
- [x] **ROSTER-02**: After the ruling, no file remains that claims to define agents and defines nothing — including `colony/policies/model-routing.yaml`, ruled in the same breath *(reworded 2026-08-13; original: hub distribution — applies only under a "wire" ruling)*
...
- [x] **SKILL-01**: The unreferenced skill-lifecycle commands either have a caller or are removed — 8 of 9 reach nobody today
...
| ROSTER-01 | Phase 191 | Remapped 2026-08-17 (ruling-by-deletion, Dead Wood) | Satisfied (2026-08-21) |
| ROSTER-02 | Phase 191 | Remapped 2026-08-17 (ruling-by-deletion, Dead Wood) | Satisfied (2026-08-21) |
...
| SKILL-01 | Phase 191 | Remapped 2026-08-17 (caller-or-removal, Dead Wood) | Satisfied (2026-08-21) |
