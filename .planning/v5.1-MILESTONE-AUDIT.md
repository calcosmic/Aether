...
gaps:
  requirements: []
  integration:
    - "Dual command directories (.claude/commands/ant/ vs commands/ant/) creates confusion"
  flows: []
tech_debt:
  - phase: general
    items:
      - "commands/ant/ contains stale pre-v5.1 versions (1103 line build.md vs 414 line)"
      - "runtime/aether-utils.sh (87 lines) vs .aether/aether-utils.sh (317 lines) - intentional minimal vs full"
      - "Legacy directory cleanup recommended"
---
