...
1. Update `runtime/aether-utils.sh` with new "contextual" type
...
|------|-------------|-------------|
| `runtime/aether-utils.sh` | Modify | Add "contextual" case to generate-commit-message function |
...
- `runtime/aether-utils.sh` line 1334 - Existing generate-commit-message function
