...
| REQ | JOBS-02 | Brief carries every task contract; full/partial completion credits exact covered tasks end to end | 03, 04, 06, 07 | COVERED | Native/external receipts, claims, credit, retry |
...
| RESEARCH | — | Shared manifest-aware receipt validator; exact task claims; root-computed artifact evidence | 04, 06 | COVERED | Same rules in both lanes |
...
| RESEARCH | — | Partial worktree files sync by accepted receipt paths before root evidence/credit; other edits remain recoverable | 08 | COVERED | Open Question 1 recommendation implemented |
| RESEARCH | — | Runtime-owned check-in policy, compact summary, pending-decision predicate, early flag conflict | 05 | COVERED | Open Question 2 centralized predicate included |
| RESEARCH | — | Canonical YAML, three wrappers, Codex skill, command guide, CLAUDE.md, CLI/schema parity | 02, 09 | COVERED | Generated schema in 02; all orchestration/docs surfaces in 09 |
| RESEARCH | — | Fail-then-pass CalVault and adversarial tests; full/race/vet/build/schema gates | 01, 03, 08, 09 | COVERED | Both in-repo and worktree paths explicitly prove one worker |
...
| CONTEXT | D-08 | Honest partial proof credits only explicit task receipts | 04, 06, 08 | COVERED | Native, external, and worktree exact credit |
| CONTEXT | D-09 | Receipt binds task requirements, claimed files, verification evidence through manifest validation | 02, 04, 06, 08 | COVERED | Wire type plus shared admission/evidence boundary |
...
| CONTEXT | D-12 | Compact non-blocking summary names worker/tasks/reason/no-approval cause | 05, 09 | COVERED | Runtime renderer and wrapper consumption |
...
| CONTEXT | Folded todo | One-worker build goes straight through without becoming invisible | 05, 09 | COVERED | Behavior lands in 05; preserved todo resolved/moved in 09 |
...
No `MISSING` rows. No phase split is required: the nine plans keep each
