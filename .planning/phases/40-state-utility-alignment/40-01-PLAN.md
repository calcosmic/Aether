...
- Change "Signals decay over time (exponential half-life)" to "Signals have TTL expiration (expires_at timestamp)"
  ...
  <verify>grep -A8 "State File" .claude/commands/ant/ant.md</verify>
  <done>ant.md documents single COLONY_STATE.json with nested sections, no mention of separate files</done>
</task>
